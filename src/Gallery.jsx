...
function Room({ position, isActive, onClick, roomName }) {
...
export default function Gallery() {
  ...
  const rooms = [
    { position: [0, 0, 0], roomName: "Main Room" },
    { position: [4, 0, 0], roomName: "Room 2" },
    { position: [-4, 0, 0], roomName: "Room 3" },
  ];
  ...
  return (
    <Canvas camera={{ position: [0, 2, 5] }}>
      ...
      {/* OrbitControls for navigating around */}
      <OrbitControls />
    </Canvas>
  );
}
